...
import { canExit, LEVELS } from './game.js?v=25';
...
import {DISTRICTS,LEVELS_PER_DISTRICT} from './campaign.js?v=25';
export {DISTRICTS};
...
export class Market extends Traffic {
  constructor(level=0,legacy=false){super(level,legacy);this.state.levelTitle=MARKET_LEVELS[this.state.levelIndex];}
