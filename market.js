import { Traffic } from './traffic.js?v=27';
import { canExit, LEVELS } from './game.js?v=27';
...
import {DISTRICTS,LEVELS_PER_DISTRICT} from './campaign.js?v=27';
export {DISTRICTS};
...
export class Market extends Traffic {
  constructor(level=0,legacy=false,garages=!legacy){super(level,legacy,garages);this.state.levelTitle=MARKET_LEVELS[this.state.levelIndex];}
