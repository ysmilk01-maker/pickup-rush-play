import { Traffic } from './traffic.js?v=44';
import { canExit, LEVELS } from './game.js?v=44';
...
import {DISTRICTS,LEVELS_PER_DISTRICT} from './campaign.js?v=44';
export {DISTRICTS};
...
export class Market extends Traffic {
  constructor(level=0,legacy=false,garages=!legacy,campaignVersion=garages?6:3){super(level,legacy,garages,campaignVersion);this.state.levelTitle=MARKET_LEVELS[this.state.levelIndex];}
