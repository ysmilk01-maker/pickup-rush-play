import { Traffic } from './traffic.js?v=37';
import { canExit, LEVELS } from './game.js?v=37';
...
import {DISTRICTS,LEVELS_PER_DISTRICT} from './campaign.js?v=37';
export {DISTRICTS};
...
export class Market extends Traffic {
  constructor(level=0,legacy=false,garages=!legacy,campaignVersion=garages?5:3){super(level,legacy,garages,campaignVersion);this.state.levelTitle=MARKET_LEVELS[this.state.levelIndex];}
  get busy(){return !!(this.running.length||this.walkers.length||this.arriving.length);}
