import { Traffic } from './traffic.js?v=49';
import { canExit, LEVELS } from './game.js?v=49';
...
import {DISTRICTS,LEVELS_PER_DISTRICT} from './campaign.js?v=49';
export {DISTRICTS};
...
export class Market extends Traffic {
  constructor(level=0,legacy=false,garages=!legacy,campaignVersion=garages?7:3){super(level,legacy,garages,campaignVersion);this.state.levelTitle=MARKET_LEVELS[this.state.levelIndex];}
