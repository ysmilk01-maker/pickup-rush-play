import { Traffic } from './traffic.js?v=58';
import { canExit, LEVELS } from './game.js?v=58';
...
import {DISTRICTS,LEVELS_PER_DISTRICT} from './campaign.js?v=58';
export {DISTRICTS};
...
export class Market extends Traffic {
  ...
  get canUndo(){return this.state.queueCut?.status!=='offered'&&!this.busy&&this.undoStack.length>0;}
  readySuggestion(){
