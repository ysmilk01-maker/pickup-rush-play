import { COLORS, canExit } from './game.js?v=11';
import { BAY, QUEUE, carPose, DIRECTIONS } from './traffic.js?v=11';
import { vehicleModel, makePassenger } from './appearance.js?v=11';
