import { COLORS, canExit } from './game.js?v=25';
import { BAY, QUEUE, carPose, DIRECTIONS } from './traffic.js?v=25';
import { vehicleModel, makePassenger } from './appearance.js?v=25';
