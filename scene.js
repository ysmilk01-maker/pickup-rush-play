import { COLORS, canExit } from './game.js?v=13';
import { BAY, QUEUE, carPose, DIRECTIONS } from './traffic.js?v=13';
import { vehicleModel, makePassenger } from './appearance.js?v=13';
