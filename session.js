import {Market} from './market.js?v=25';
import {CAPACITY} from './traffic.js?v=25';
...
export function restoreSession(raw,unlocked){
  try{
    ...
    if(raw.rules!==3&&raw.level>=36)return null;
    const m=new Market(raw.level,raw.rules!==3),d=raw.data,s=d?.state;
    ...
    m.demandVersion=raw.rules===3?3:raw.rules===2?2:1;
