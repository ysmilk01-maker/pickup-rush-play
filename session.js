import {validPuzzle} from './puzzle.js?v=47';
import {Market} from './market.js?v=47';
import {pendingCars} from './garage.js?v=47';
import {CAPACITY} from './traffic.js?v=47';
import {emergencyLimit} from './emergency.js?v=47';
