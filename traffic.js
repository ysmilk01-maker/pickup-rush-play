import { createGame, canExit, COLORS, VEHICLE_TYPES } from './game.js?v=33';
import { assignModels, makePassenger } from './appearance.js?v=33';
import { isFreeform, bounds, LOT, GROUND_SCALE, overlaps } from './geometry.js?v=33';
import {garagePlan,pendingCars,nextWave} from './garage.js?v=33';
import { passengerQueue } from './demand.js?v=33';
